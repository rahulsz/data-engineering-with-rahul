...
export default function Section1Hero() {
  ...
  const progressCircumference = 2 * Math.PI * 38; // r=38
  const progressOffset = progressCircumference; // 0% progress
      ...
      <div className="grid grid-cols-1 md:grid-cols-[1fr_260px] gap-0 min-h-[400px]">
        ...
        >
          ...
          <div className="relative w-24 h-24">
            <svg className="w-full h-full -rotate-90" viewBox="0 0 100 100">
              ...
              <motion.circle
                ...
                strokeWidth="8"
                strokeLinecap="round"
                initial={{ strokeDasharray: progressCircumference, strokeDashoffset: progressCircumference }}
                animate={mounted ? { strokeDashoffset: progressOffset } : {}}
          ...
          <div className="w-full flex flex-col gap-2">
            <button
              className="w-full py-2.5 px-4 rounded-lg bg-[#253141] text-[#D1D5DB] hover:bg-[#2A3645] hover:text-white transition-all flex items-center justify-center gap-2 text-sm font-semibold group cursor-not-allowed opacity-70"
