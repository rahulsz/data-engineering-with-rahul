...
export default function CompleteButton({ weekId }: { weekId: number }) {
  ...
  return (
    <button
      ...
      className="flex items-center gap-2 px-4 py-2 rounded-full border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-all font-medium text-sm text-zinc-700 dark:text-zinc-300 shadow-sm hover:shadow-md"
    >
      <motion.div
        initial={false}
