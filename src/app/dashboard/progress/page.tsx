    ...
    <div className="min-h-screen bg-[#0F151B] text-[#E5E7EB] font-sans flex selection:bg-[#F97316]/30">
      ...
      <aside className="w-[280px] border-r border-[#1e293b] flex flex-col hidden lg:flex shrink-0 bg-[#0B111A]">
        ...
        <nav className="flex-1 px-4 mt-8 space-y-2 relative">
          ...
          {/* Active */}
          <Link href="/dashboard/progress" className="flex items-center gap-3 px-4 py-3 rounded-lg bg-[#2A1D16] text-[#F97316] font-semibold border-l-4 border-[#F97316]">
            <BarChart2 className="w-5 h-5" />
            Progress
          </Link>
          <Link href="/dashboard/settings" className="flex items-center gap-3 px-4 py-3 rounded-lg text-[#9CA3AF] font-medium hover:bg-[#1e293b]/50 hover:text-white transition-colors ml-1">
      ...
      <main className="flex-1 overflow-y-auto bg-[#0F151B] flex flex-col">
        ...
        <div className="flex-1 p-8 lg:p-12 lg:pl-16 pb-24 max-w-7xl">
